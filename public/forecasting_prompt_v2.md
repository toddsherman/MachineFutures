...
Q5. On December 31, 2030, a model ranked in the top 3 on the primary public text-model leaderboard (LMArena or its named successor) is available through a public API priced at or below 2 US dollars per million output tokens, per published provider pricing.
...
Q13. An autonomous AI system is FDA-cleared to make a definitive diagnosis of a life-threatening condition (such as cancer, stroke, or a cardiac event) with no requirement for physician confirmation of the result.
...
Q20. US employment in software development occupations (BLS OES category 15-1252 or its successor) declines at least 20% from its 2024 level, per the most recent BLS data available on December 31, 2030.
...
Q23. A single AI datacenter or training cluster with more than 1 gigawatt of power capacity comes online and is generating power, per company and grid-operator reporting.
...
Q35. A major US-headquartered or China-headquartered frontier AI developer officially halts deployment of its flagship model in the European Union, specifically citing the EU AI Act's compliance, auditing, or liability obligations.
