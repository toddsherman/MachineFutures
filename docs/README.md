...
Dataset-specific references live beside the material they describe:

- [Generated data dictionary](../data/README.md)
- [Raw-run format](../runs/README.md)
- [Retired instruments](../archive/README.md)
