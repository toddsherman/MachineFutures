(function () {
  ...
  const statesByHorizon = { 'long-term': states, '2030': snapshotStates, '2040': snapshotStates, '2050': snapshotStates, '2060': snapshotStates };
  ...
  window.MF_DATA = {
    ...
    horizons: [
      ...
      { id: '2060', label: '2060', targetYear: 2060 }
    ],
    datasets: {
      ...
      '2060': dataFor('2060', '2026-05-06', [['alpha', 'Anthropic', 'Alpha'], ['beta', 'OpenAI', 'Beta'], ['gamma', 'Google', 'Gamma']], 6)
    }
  };
})();
